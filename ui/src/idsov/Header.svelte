<script lang="ts">
  import { navigate, view, dProfilesClient, dProfilesStore } from "../store";
  ...
  import { dConnected, dInitialized } from "../store";
...
<Router {url}>
  ...
  <div class="navbar bg-base-100">
    <div class="navbar-start">
      ...
      <!--     <li><Link to="/timeline">Phases</Link></li> -->
    ...
    <div class="navbar-center">
      <Link class="btn btn-ghost text-xl bg-base-200" to="/">IDSOV</Link>
    </div>
